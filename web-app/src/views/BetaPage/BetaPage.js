            ...
            <GridContainer>
               <GridItem xs={12}>
                  <div className={classes.container}>
                     ...
                     <h4>
                        We&apos;re glad that you want to join Goat Duels. The bad news is that this app is still in beta and is not open to the public. The good
                        news is that it&apos;s easy for you to become a beta tester if you want to. Please watch the video below about why I created Goat Duels
                        and how you can become a beta tester.
                     </h4>
                     <iframe
                        width="560"
                        height="315"
